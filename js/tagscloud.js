...
/* global d3, _, tags */
function createTagsCloud(tagsIdx) {
    ...
    function generateTagCloud(retryCycle) {
        var tagsToDraw = transformToCloudLayoutObjects(tagsIdx, retryCycle);
        d3.layout.cloud()
            .size([width, height])
            .words(tagsToDraw)
            .rotate(function () {
        ...
        function drawTagCloud(words) {
            ...
            d3.select("#cloud").append("svg")
                ...
                .data(words)
                .enter().append("text")
                .on("click", function() {addTagToInput (this) })
